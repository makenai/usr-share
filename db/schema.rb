...
ActiveRecord::Schema.define(:version => 20111210010000) do
  ...
  add_index "recommendations", ["cached_votes_total"], :name => "index_recommendations_on_cached_votes_total"
